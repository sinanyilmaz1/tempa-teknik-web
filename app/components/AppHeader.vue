...
<template>
  ...
  <header
    class="w-full border-b border-anthracite-700 bg-anthracite-800 [--ui-text-muted:var(--color-light-gray)] [--ui-text-highlighted:var(--color-beyaz)] [--ui-text:var(--color-light-gray)]"
  >
    <div class="mx-auto max-w-7xl px-4 py-8 flex items-center justify-between gap-4">
      ...
      <!-- Desktop nav -->
      <UNavigationMenu :items="items" class="hidden lg:flex" orientation="horizontal" />
